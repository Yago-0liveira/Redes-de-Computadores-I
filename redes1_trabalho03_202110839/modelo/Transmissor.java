...
public class Transmissor {
  ...
  public Transmissor(PrincipalController pc) { // construtor
    this.pc = pc;
  }
  ...
  public void CamadaDeAplicacaoTransmissora(String mensagem) { // O metodo define o texto ao escolher uma codificacao
    ...
    // CamadaFisicaTransmissora(quadro, tCodificacao,tipoDeEnquadramento);
    enlaceTransmissora = new CamadaEnlaceTransmissora(pc);
    enlaceTransmissora.CamadaEnlaceDadosTransmissora(quadro, tCodificacao, tipoDeEnquadramento, tipoDeControleDeErro);

  }

  public void CamadaFisicaTransmissora(int quadro[], int tCodificacao, int tEnquadramento, int tipoDeControleDeErro) { // o
                                                                                                                       // metodo
                                                                                                                       // transmite
                                                                                                                       // a
    // mensagem para a
