...
public class Receptor {
  ...
  public void CamadaFisicaReceptora(int quadro[], int tCodificacao, int tEnquadramento) { // Chamar a decodificacao especifica
  ...
  public static int[] binarioParaDecimal(int[] nBinario) { // metodo responsavel por transformar o numero binario em
    ...
    for (int i = 0; i < numeroDeSegmentos; i++) {
      ...
      // Converte o segmento binario em um namero decimal e armazena no array
